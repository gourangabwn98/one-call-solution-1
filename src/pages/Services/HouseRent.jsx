      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-2xl mx-auto text-gray-600">
            ...
            >
              Make your events unforgettable with our professional decoration
              services. From weddings to birthdays, we tailor designs to your
              vision in Burdwan.
            </motion.p>
          </div>
        </div>
